...
spacetime
because they are so massive (Mattson 2010).  They are so massive that they have
what is called
...
masses.  This relationship was discovered by Karl Schwarzschild in 1916 (Mattson
2010).

Black holes are believed to be able to exist in three different size classes:
miniature, stellar mass, and supermassive (Mattson 2010).  Stellar mass black
holes are the
...
black holes, on average $10^6 -10^9$ solar masses in size (Mattson 2013).
...
but are scaled up to enormous masses (Ferrarese and Merritt 2002).  This means
...
which would not give these objects a lot of time to form (Ferrarese and Merritt
2002).
...
luminosity in the UV, optical, and infrared spectra (Whittle 2011a).  Quasars
fall into the
...
different AGN can be detected is described later (Whittle 2011a).


\subsection{Supermassive Black Hole Accretion}
Supermassive black holes grow by accreting large amounts of matter in
galactic systems (Narayan \& Quataert 2005).  Because of this, an accretion
disk forms around the black
...
friction (Narayan \& Quataert 2005).
...
distinct categories based on their corresponding $\epsilon$ (Narayan \&
Quataert 2005).  If the
...
that the thin disks are preferred (Narayan \& Quataert 2005).
...
radio jets (Narayan \& Quataert 2005).  These jets are not present in all
supermassive black holes, but
...
gets twisted and propagates out, causing a large outflow (Narayan \& Quataert
2005).
...
detected by their spectral emission lines and other visible properties (Begelman
\& Rees 2009).
    ...
    by its gravitational effects on surrounding visible matter (Begelman \& Rees
    2009).  Because of
    ...
    objects can be observed in a large portion of it (Begelman \& Rees 2009).
    ...
    several ways (Begelman \& Rees 2009).  First, it increases the velocity
    of stars as they approach the
    ...
    to larger fractions of $c$ (Begelman \& Rees 2009).

    Another way that a supermassive black hole's gravity affects central stars
    is by distorting their orbits (Begelman \& Rees 2009).  These central stars
    ...
    them besides their gravitational influence on other objects (Whittle 2011a).
    However,
    ...
    typically how AGN are differentiated from stellar radiation sources (Whittle
    2011a).
    ...
    classify them (Whittle 2011a).  There seem to be two clear ways that AGN can
    differ from
    ...
    optical spectrum (Whittle 2011a).

    \subsubsection{Observation in the Milky Way}
    Recent research has found a moderately size supermassive black hole at the
    center of the Milky Way (Ferrarese \& Merritt 2002).  It is called
    Sagittarius A, and is believed to be
...
properties (The Sloan Digital Sky Survey).  When considering nearby galaxies
(redshift $z < 1$), the Hubble
classification system works well for classifying the many different galaxies in
the Local Group and beyond.  Hubble's
...
three categories have many similar characteristics  (The Sloan Digital Sky
Survey).
    ...
    morphological components, one of which is the stellar halo (Whittle 2011b).
    ...
    for globular clusters to form (Whittle 2011b).
    ...
    center of the disk (Whittle 2011b).  This section contains mostly old,
    metal-rich stars that
    ...
    spiral class (Whittle 2011b).

    This central bulge forms the center of the two largest structures in spiral
    galaxies: the thin and thick disks (Whittle 2011b).  These disks make up most
    of the mass of
    ...
    thick disks (Whittle 2011b).  Furthermore, they tend to have a relatively
    high amount of new
    ...
    red center as less star formation is occurring there (Whittle 2011b).
    ...
    are precursors to these types of galaxies (The Sloan Digital Sky Survey).
    ...
    the monolithic collapse of primordial cold dust clouds (Kauffmann and van
    den Bosch, 2002).  This collapse would
    create an environment where star formation would flourish, and the intrinsic
    angular momentum of the gas would be transferred to new stars (Kauffmann and
    van den Bosch, 2002).

    On the other
    hand, it is believed that elliptical galaxies form from the merging of two
    spiral galaxies that are similar in size (Kauffmann and van den Bosch, 2002).
    This type of merging would
    ...
    the central bulge (Kauffmann and van den Bosch, 2002).

    These two events, formation and merging, make up the two major events in a
    galaxy's lifetime that dramatically change its morphology (Kauffmann and van
    den Bosch, 2002).  Supermassive
...
relationship has been plotted and shows a tight correlation.  The important
takeaway from this
...
these methods below (Brennan 2012).
    ...
    radio galaxies these line up very well with the radio lobes.  One possible
    explanation for these bubbles is that the jets are
...
clearly an important process (McNamara 2012).
    ...
    in the center of these galaxies (Heckman, 2008).  This also explains why
    the central bulge
...
in the galaxy follow regarding whether they form an elliptical or a larger spiral
...
the galactic nucleus of the resulting galaxy will be quite different: it has
...
theoretically possible and a probable outcome of this type of merger
(Khan et al. 2012).
...
size.  The high levels of accretion observed in AGN heats the host
galaxy
...
Begelman, M., Rees, M., 2009, {\it Gravity's Fatal Attraction}, Cambridge
University Press, Cambridge, p. 162-182.
...
\url{http://arxiv.org/abs/0809.1101}, (October 17, 2013).
...
Merger Remnants, Cornell University Library,
\url{http://arxiv.org/abs/1202.2124v1}
(December 5, 2013).

\vspace{5mm}

Mattson, B., 2010, Black holes, {\it NASA Goddard Space Flight Center},
\url{http://imagine.gsfc.nasa.gov/docs/science/know\_l2/black\_holes.html} (December 2,
2013).
\vspace{5mm}
...
\url{http://arxiv.org/abs/1211.2816} (October 13, 2013).
...
Narayan, R., Quataert, E., 2005, Black hole accretion, {\it Science}, v307, pp.
77-80.

\vspace{5mm}

Whittle, 2011(a), Active Galaxies and Quasars, Extragalactic Astronomy,
\url{http://www.astro.virginia.edu/class/whittle/astr553/Topic15/Lecture\_15.html}j
(December 1, 2013).

\vspace{5mm}
Whittle, 2011(b), Spiral galaxies, Extragalactic Astronomy,
\url{http://www.astro.virginia.edu/class/whittle/astr553/Topic15/Lecture\_5.html}
(December 1, 2013).

\vspace{5mm}
Whittle, 2011(c), Elliptical Galaxies, Extragalactic Astronomy,
\url{http://www.astro.virginia.edu/class/whittle/astr553/Topic15/Lecture\_7.html}
(December 1, 2013).


\vspace{5mm}
{\it NA}, Skyserver, {\it The Sloan Digital Sky Survey},
\url{http://cas.sdss.org/dr7/en/proj/basic/galaxies/default.asp} (December 1, 2013).
